...
@click.option(
    "--description",
    default="Answer questions related to Vertex AI documentation using Vertex AI RAG Engine and enrich with Google Search as needed",
...
@click.option(
    "--requirements-file",
    default="rag/app_utils/.requirements.txt",
